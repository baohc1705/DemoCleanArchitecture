...
{
    public class ArchiveNewsCommandHandler : IRequestHandler<ArchiveNewsCommand, int>
    {
        private readonly INewsRepository _newsRepository;
        private readonly IMapper _mapper;
        public ArchiveNewsCommandHandler(INewsRepository newsRepository, IMapper mapper)
        {
            _newsRepository = newsRepository;
            _mapper = mapper;
        }
        public async Task<int> Handle(ArchiveNewsCommand request, CancellationToken cancellationToken)
        {
